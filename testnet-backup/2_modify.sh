...
for (( i=0; i<${NUM_NODES}; i++ )); do
    ...
    #rm -f ${NODE_DIR}/execution/jwtsecret
...
#    echo "${PRYSM_BEACON_BINARY} is starting"
#    ps -ef | grep ${PRYSM_BEACON_BINARY}
...
#    echo "${PRYSM_VALIDATOR_BINARY} is starting"
#    ps -ef | grep ${PRYSM_VALIDATOR_BINARY}
...
#        echo "curl localhost:4100/eth/v1/node/identity"
